...
Use the Individuals Foreign Income API to submit, edit and retrieve information about a customer's foreign earnings and unremittable foreign income.

This API is related to the following customer journey:
* Submit foreign income
