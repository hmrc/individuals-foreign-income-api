...
@Singleton
class CreateAmendForeignService @Inject() (connector: CreateAmendForeignConnector) extends BaseService {

  def amendForeign(request: CreateAmendForeignRequest)(implicit ctx: RequestContext, ec: ExecutionContext): Future[ServiceOutcome[Unit]] = {
